...
There is existing research that indicates a significant negative correlation between high group Communication Apprehension (CA) scores and public transportation frequency usage. Because public transit settings have been indicated to predict heightened levels of generalized anxiety and distress among adult populations (@SarmientoSuarez2026), it is reasonable that individuals with elevated baseline communication apprehension would avoid high-stimulus, socially dense environments, like public transportation, disproportionately when compared to more relaxed peers.

While there is substantial evidence that access to robust public transportation can actually improve mental wellbeing (@cdcfoundation2020hi5), there is also substantial research on transit-induced stress that may support our hypothesis that public transportation usage is a function of group Communication Apprehension.
...
```{python}
#| label: ANOVA_plot.png
#| fig-cap: "Bar Chart Showing Public Transportation Usage in the Last 3 Months Based on Communication Aprehension Scores"
![Bar Chart](ANOVA_plot.png)
```
...
This chart represents the average composite communication apprehension score across all participants based on their answer to the question about the number of days they used public transportation in a month, with margins for significant error included. There is a significant difference seen between the mean composite communication scores for participants who answered that they never used public transportation and those who answered that they used public transportation more than 7 days in a month.
